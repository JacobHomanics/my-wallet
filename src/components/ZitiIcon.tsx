...
export function ZitiIcon({
  ...
  const iconDetailColor = detailColor ?? colors.bg;
  ...
  return (
    ...
    >
      ...
      />
      {/* Coin slot */}
      <Rect x="9" y="5" width="6" height="1.35" rx="0.65" fill={iconDetailColor} />
      {/* Body */}
      <Path
      ...
      <Path
        d="M5.75 15.25h12.5"
        stroke={iconDetailColor}
        strokeWidth={1.35}
        strokeLinecap="round"
      />
      {/* Drawer pull */}
      <Rect x="10" y="17" width="4" height="1.6" rx="0.8" fill={iconDetailColor} />
      {/* Coin */}
      <Circle cx="12" cy="11.35" r="2.35" fill={iconDetailColor} />
      {/* Dollar */}
      <Path
