...
| `REWARD_TOKEN_ADDRESS` | no | Defaults to Base SE2Token `0x4ed932ac83f77a5d4f3d950ab9ba90882ed06e55` |
| `REWARD_TOKEN_AMOUNT` | no | Whole tokens to send after a successful payment (default `1`) |
