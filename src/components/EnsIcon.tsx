...
/** Official ENS blue. */
export const ENS_BLUE = '#0080BC';

type EnsIconProps = {
  size?: number;
  /** When true, include the blue rounded square background. */
  withBackground?: boolean;
  color?: string;
};

/**
 * ENS brand mark (from ENS brand assets / Simple Icons).
...
export function EnsIcon({
  ...
  return (
    <Svg
      ...
      accessibilityLabel="ENS"
    >
      {withBackground ? (
        <Rect width="24" height="24" rx="4.8" fill={ENS_BLUE} />
      ) : null}
      <Path
